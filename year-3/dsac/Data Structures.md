...
#### 1. Left Rotation
##### Algorithm:
Let node x be where the imbalance occurs, and node y be the right child of x.
##### Perform Rotation:
- Make y the new root of the subtree.
- Move y's left child to be x's right child.
- Update y's left child's parent to x.
- Adjust parent pointers.
##### Steps:
- Set y to x's right child.
- Assign y's left subtree to x's right subtree.
- Update y's left child's parent to x.
...
#### 2. Right Rotation
##### Algorithm:
Let node x be where the imbalance occurs, and node y be the left child of x.
##### Perform Rotation:
- Make y the new root of the subtree.
- Move y's right child to be x's left child.
- Update y's right child's parent to x.
- Adjust parent pointers.
##### Steps:
- Set y to x's left child.
- Assign y's right subtree to x's left subtree.
- Update y's right child's parent to x.
- Link x's parent to y.
